...
const query = (groq__WEBPACK_IMPORTED_MODULE_6___default())`*[_type == "ourWork" && slug.current == $slug][0]{
  title,
  mainImage,
  body,
  publishedAt
...
const getStaticPaths = async ()=>{
    const paths = await _client__WEBPACK_IMPORTED_MODULE_5__/* ["default"].fetch */ .Z.fetch((groq__WEBPACK_IMPORTED_MODULE_6___default())`*[_type == "ourWork" && defined(slug.current)][].slug.current`);
    return {
...
var __webpack_exports__ = __webpack_require__.X(0, [505,61,36,235], () => (__webpack_exec__(518)));
