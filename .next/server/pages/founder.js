...
const query = (groq__WEBPACK_IMPORTED_MODULE_6___default())`*[_type == "founder"][0]{
  title,
  mainImage,
  body
}`;
...
var __webpack_exports__ = __webpack_require__.X(0, [505,61,36,235], () => (__webpack_exec__(8467)));
